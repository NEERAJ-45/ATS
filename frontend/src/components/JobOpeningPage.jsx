...
const JobOpeningPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:3000/application/apply", data, {
        headers: {
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col justify-center items-center p-6">
        ...
        <div className="w-full max-w-6xl bg-gray-900 p-10 rounded-3xl shadow-xl mt-6 animate-fade-in transition duration-700">
          <h1 className="text-4xl font-bold text-center mb-6">SDE I - Job Opening</h1>

          <div className="grid md:grid-cols-2 gap-8 text-gray-300 mb-4">
            <div className="space-y-2">
              <p><span className="font-semibold text-white">Company:</span> DKTE Technologies</p>
              <p><span className="font-semibold text-white">Location:</span> Remote / Bangalore</p>
              <p><span className="font-semibold text-white">CTC:</span> ₹12 - ₹15 LPA</p>
              <p><span className="font-semibold text-white">Experience:</span> 0-2 years</p>
            </div>
            <div className="space-y-2">
              <p><span className="font-semibold text-white">Skills:</span> React.js, Node.js, JavaScript</p>
              <p><span className="font-semibold text-white">APIs:</span> REST APIs, Express.js</p>
              <p><span className="font-semibold text-white">Tools:</span> Git, Postman, Docker</p>
            </div>
          </div>

          <p className="text-sm text-gray-400 mt-4">
            Join a fast-paced environment and work with cutting-edge technology. We value clean code, collaboration, and growth. Apply now and be part of something exciting!
          </p>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
            <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-xl p-8 transform scale-95 animate-zoom-in relative">
              ...
              <h2 className="text-2xl font-bold text-center text-white mb-4">Apply for SDE I</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {[ 
                  ...
                  { label: "Mobile Number", name: "phone", type: "text", placeholder: "10-digit phone number" },
                  { label: "Skills", name: "skills", type: "text", placeholder: "React, Node.js, etc." }
